...
- For `today-section`, prefer editing `<session-name>/What we are doing Today/notes.md` directly. Use `today-section.notesFile` in the blueprint only as an override when you intentionally want to source content from somewhere else.
